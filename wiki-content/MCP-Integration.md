...
SuperLocalMemory V2.1.0 includes a universal **mcp-server** that provides native integration with 11+ IDEs including Claude Desktop, Cursor IDE, Windsurf, and more. This local-first, mcp-protocol based integration enables AI assistants to naturally access your memory system without manual commands.
