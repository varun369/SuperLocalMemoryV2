...
> **[View Interactive Architecture Diagram](https://superlocalmemory.com/architecture)** — Explore all 10 layers, MCP + A2A dual protocol, and v2.5 components in an interactive visualization. Click any layer for details.
